...
<div id="contentarea">
	...
	Nama anda : <b><?=$this->session->userdata('Nama_Lengkap');?></b><br>
  <table class="table table-hover">
	...
	if ($row->Status == 1)
	{
		echo "<td style='color:green'>Sudah Bayar </td>";
	}
	else
	{
		echo "<td style='color:red'>Belum Bayar </td>";
	}
	?>
	<td> <a href = "<?=base_url();?>index.php/kru/EditMentor/<?=$row->NIM;?>/<?=$row->Status;?>">Edit</a></td>
	</tr>
	<?php 
	}
	?>
