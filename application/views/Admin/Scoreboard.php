...
<!-- Tempat Isi Konten -->
	<button class="btn btn-primary" type="button" id="LulusTahap1">LulusTahap1</button>
	...
	<td><b> Nama </b></td>
	<td><b> Skor </b></td>
	<td><b> IsLulusTahap1</b></td>
	<td><b> IsLulusTahap2</b></td>
	<td><b> IsLulusTahap3</b></td>
	<td><b> Mentor </b></td>
	</tr>
	...
	<td>
	<?php
		if ($row->IsLulusThp1 == 0)
			echo "<font color='red'>Tidak Lulus tahap 1</font>";
		else
			echo "<font color='green'>Lulus tahap 1</font>";
	?>
	</td>
	<td>
	<?php
		if ($row->IsLulusThp2 == 0)
			echo "<font color='red'>Tidak Lulus tahap 2</font>";
		else
			echo "<font color='green'>Lulus tahap 2</font>";
	?>
	</td>
	<td>
	<?php
		if ($row->IsLulusThp3 == 0)
			echo "<font color='red'>Tidak Lulus tahap 3</font>";
		else
			echo "<font color='green'>Lulus tahap 3</font>";
	?>
	</td>
	<td><font color='blue'><?=$row->mentor;?></font></td>
	</tr>
	<?php 
	}
	?>
