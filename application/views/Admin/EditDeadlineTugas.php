...
<form action="<?=base_url();?>index.php/kru/EditDeadline/" method="POST">
  ...
  <fieldset>
   <legend> Edit Deadline Tugas</legend>
    ...
    <select name="Tugas">
	<option value="Deadline1">Tugas 1</option>
    <option value="Deadline2">Tugas 2</option>
	<option value="Deadline3">Tugas 3</option>
	<option value="Deadline4">Tugas 4</option>
	<option value="Deadline5">Tugas Besar</option>
	<option value="Deadline6">Tugas Kecil</option>
	<option value="Deadline7">Tugas Awal </option>
	<option value="Deadline8">TP ke-1</option>
	<option value="Deadline9">TP ke-2</option>
	<option value="Deadline10">TP ke-3</option>
	</select>
...
<p style="color:blue">Deadline Tugas Besar : <?=$row->Deadline5;?></p>    
<p style="color:blue">Deadline Tugas Kecil : <?=$row->Deadline6;?></p> 
<p style="color:blue">Deadline Tugas Awal : <?=$row->Deadline7;?></p> 
<p style="color:blue">Deadline TP ke-1 : <?=$row->Deadline8;?></p> 
<p style="color:blue">Deadline TP ke-2 : <?=$row->Deadline9;?></p> 
<p style="color:blue">Deadline TP ke-3  : <?=$row->Deadline10;?></p> 
	<br>
	<?php
	}
	?>
