...
<script type="text/javascript">
	$().ready(function() {
		$('textarea.tinymce').tinymce({
			...
			template_external_list_url : "<?=base_url();?>lists/template_list.js",
			external_link_list_url : "<?=base_url();?>lists/link_list.js",
			external_image_list_url : "<?=base_url();?>lists/image_list.js",
			media_external_list_url : "<?=base_url();?>lists/media_list.js",
...
<!-- Tempat Isi Konten -->
<div id="contentarea">
    <form action = "<?=base_url();?>index.php/kru/BuatTugas" method="POST">
    <fieldset>
    <legend>Buat Tugas</legend>
	
	<label>Tugas Ke-</label>
    <select name="tugaske">
	<option value="Tugas ke-1">Tugas ke-1</option>
	<option value="Tugas ke-2">Tugas ke-2</option>
	<option value="Tugas ke-3">Tugas ke-3</option>
	<option value="Tugas ke-4">Tugas ke-4</option>
	<option value="Tugas Besar">Tugas Besar</option>
	<option value="Tugas Kecil">Tugas Kecil</option>
	<option value="Tugas Awal">Tugas Awal</option>
	<option value="TP ke-1">TP ke-1</option>
	<option value="TP ke-2">TP ke-2</option>
	<option value="TP ke-3">TP ke-3</option>
	</select>
	...
	<textarea id="elm1" name="Soal" rows="10" cols="50" style="width: 80%" class="tinymce">
		
	</textarea>
    <span class="help-block">Buat Soal disini</span>
    
	<label>Password</label>
	<input type="text" name="SoalPasswd">
	<span class="help-block">Sengaja ditampilkan agar tidak salah mengetikkan password</span>
...
{
echo "<h2>Tugas yang pernah dibuat sebelumnya</h2><br>";
echo "=================================================<br>";
echo $row->Soal."<br>";
echo "<b>Password : ".$row->SoalPasswd."<br></b>";
echo "====================================================";
}
?>
