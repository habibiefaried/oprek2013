...
<!-- Tempat Isi Konten -->
<div id="contentarea">
<h3>Perhatian!! Izin tidak mengikuti oprek ARC karena kegiatan lain 
(unit / himpunan) tidak akan diterima. ARC akan memberikan surat izin
    agar anda diizinkan tidak mengikuti acara tersebut. Untuk memperoleh
 surat izin tersebut, silahkan download
    <a href="http://oprek.arc.itb.ac.id/surat_izin.docx" style="color: rgb(255, 0, 0);">di sini</a><br><br>
    Untuk izin sakit harap melampirkan surat sakit, dan untuk acara keluarga harap mencantumkan surat pernyataan dari
    orang tua<br><br>
    Terima Kasih
</h3></div>
...
<!-- Login Cakru -->
	...
	<div class="sidebarleft floatleft">
		...
		<div class="textwidget">
			...
			<a href='<?=base_url();?>Peraturan_Oprek.pdf'>Peraturan Oprek</a><br>
			<a href="http://oprek.arc.itb.ac.id/surat_izin.docx">Download surat Izin Oprek ARC 2012</a><br>
		</div>
		</li>
		</ul>
