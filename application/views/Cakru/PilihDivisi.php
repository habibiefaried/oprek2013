...
<div id="contentarea">
	...
	<form action="<?=base_url();?>index.php/cakru/PilihDivisi" method="POST">
    <fieldset>
    <legend>Pilih Divisi</legend>
    <label><b>Divisi anda sekarang : <?=$this->session->userdata('Divisi');?></b></label>
	<label>Divisi</label>
	<select name="Divisi">
	<option value="Net">Divisi Network</option>
	<option value="Web">Divisi Web</option>
	<option value="RW">Divisi Radio Wireless</option>
	</select>
    <span class="help-block">Pilih Divisi yang anda inginkan</span>
