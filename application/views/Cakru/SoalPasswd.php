...
<!-- Tempat Isi Konten -->
<div id="contentarea">
    <form action="<?=base_url();?>index.php/cakru/LihatTugas" method="POST">
    <fieldset>
    <legend>Soal</legend>
    <label>Password</label>
    <input type="text" placeholder="password" name="SoalPasswd">
    <span class="help-block">Hayo2 passwordnya apa? tanya mentor sana :p</span>
