...
<table class="table table-hover">
	...
	<td><b> No </b></td>
	<td><b> NIM Cakru </b></td>
	<td><b> Absen Masuk day 1 </b></td>
	<td><b> Absen Keluar day 1 </b></td>
	<td><b> Absen Masuk day 2 </b></td>
	<td><b> Absen Keluar day 2 </b></td>
	<td><b> Absen Masuk day 3 </b></td>
	<td><b> Absen Keluar day 3 </b></td>
	<td><b> Absen Masuk day 4 </b></td>
	<td><b> Absen Keluar day 4 </b></td>
	<td><b> Absen Masuk day 5 </b></td>
	<td><b> Absen Keluar day 5 </b></td>
	</tr>
	...
	?>
		...
		<td> <?=$row->NIM;?> </td>
		<?php
		if ($row->hadir1in == '0') echo "<td style='color:red'>Belum Absen </td>";
		else echo "<td style='color:green'>Sudah Absen</td>";
		
		if ($row->hadir1out == '0') echo "<td style='color:red'>Belum Absen </td>";
		else echo "<td style='color:green'>Sudah Absen</td>";
		
		if ($row->hadir2in == '0') echo "<td style='color:red'>Belum Absen </td>";
		else echo "<td style='color:green'>Sudah Absen</td>";
		
		if ($row->hadir2out == '0') echo "<td style='color:red'>Belum Absen </td>";
		else echo "<td style='color:green'>Sudah Absen</td>";
		
		if ($row->hadir3in == '0') echo "<td style='color:red'>Belum Absen </td>";
		else echo "<td style='color:green'>Sudah Absen</td>";
		
		if ($row->hadir3out == '0') echo "<td style='color:red'>Belum Absen </td>";
		else echo "<td style='color:green'>Sudah Absen</td>";
		
		if ($row->hadir4in == '0') echo "<td style='color:red'>Belum Absen </td>";
		else echo "<td style='color:green'>Sudah Absen</td>";
		
		if ($row->hadir4out == '0') echo "<td style='color:red'>Belum Absen </td>";
		else echo "<td style='color:green'>Sudah Absen</td>";
		
		if ($row->hadir5in == '0') echo "<td style='color:red'>Belum Absen </td>";
		else echo "<td style='color:green'>Sudah Absen</td>";
		
		if ($row->hadir5out == '0') echo "<td style='color:red'>Belum Absen </td>";
		else echo "<td style='color:green'>Sudah Absen</td>";
