...
<h3> Edit Nilai </h3>
    <form class="form-inline" action="<?=base_url();?>index.php/kru/PenilaianTugas/" method="POST">
    <input type="text" class="input-small"placeholder="NIM" name="NIM">
    <input type="text" class="input-mini" placeholder="Tugas 1" name="Skor1">
	<input type="text" class="input-mini" placeholder="Tugas 2" name="Skor2">
	<input type="text" class="input-mini" placeholder="Tugas 3" name="Skor3">
	<input type="text" class="input-mini" placeholder="Tugas 4" name="Skor4">
	<input type="text" class="input" placeholder="Tugas Besar" name="Skor5">
	<br/>
	<br/>
	<input type="text" class="input" placeholder="Tugas Kecil" name="Skor6">
	<input type="text" class="input" placeholder="Tugas Awal" name="Skor7">
	<input type="text" class="input-mini" placeholder="TP 1" name="Skor8">
	<input type="text" class="input-mini" placeholder="TP 2" name="Skor9">
	<input type="text" class="input-mini" placeholder="TP 3" name="Skor10">
    <button type="submit" class="btn">Nilai</button>
    </form>
...
?>
  ...
  <td style="color:green"><?=$row->skor1;?></td>
  <td style="color:green"><?=$row->skor2;?></td>
  <td style="color:green"><?=$row->skor3;?></td>
  <td style="color:green"><?=$row->skor4;?></td>
  <td style="color:green"><?=$row->skor5;?></td>
  <td style="color:green"><?=$row->skor6;?></td>
  <td style="color:green"><?=$row->skor7;?></td>
  <td style="color:green"><?=$row->skor8;?></td>
  <td style="color:green"><?=$row->skor9;?></td>
  <td style="color:green"><?=$row->skor10;?></td>
  </tr>
