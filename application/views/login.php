...
<!-- Tempat Isi Konten -->
<div id="contentarea">
<form class="form-horizontal" action="<?=base_url();?>index.php/main/login" method="POST">
<legend>Login</legend>
<label><p style="color: #FF0000"><?=$error;?></p></label> 
...
<center><span class="help-block"><a style="color:blue" href="<?=base_url();?>index.php/main/LupaPass">Lupa Password? </a></span></center>
